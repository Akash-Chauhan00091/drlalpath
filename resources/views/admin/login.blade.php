...
<!-- Mirrored from themesbrand.com/velzon/html/default/auth-signin-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Sep 2022 10:10:57 GMT -->
<head>
...
<body>
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign in to continue to Dr. Lal PathLabs</p>
                                </div>
                                <div class="p-2 mt-4">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> Dr. Lal Path Labs.  Crafted with <i class="mdi mdi-heart text-danger"></i> by G.O.A.T. Web Pvt Ltd.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <!-- particles js -->
    <script src="{{asset('admincss/libs/particles.js/particles.js')}}"></script>
    <!-- particles app js -->
    <script src="{{asset('admincss/js/pages/particles.app.js')}}"></script>
    <!-- password-addon init -->
    <script src="{{asset('admincss/js/pages/password-addon.init.js')}}"></script>
</body>
