                                            ...
                                            <table class="table align-middle table-nowrap" id="customerTable">
                                                ...
                                                <tbody class="list form-check-all">
                                                    <tr>
                                                        ...
                                                        <td class="name">Deep</td>
                                                        <td class="designation">marycousar@velzon.com</td>
                                                        <td class="review">580-464-4694</td>
                                                        <td>
                            ...
                            <div class="modal-content">
                                ...
                                <form>
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            <label for="review-field" class="form-label">Review</label>
                                            <input type="number" id="review-field" class="form-control" placeholder="Enter Review" required />
                                        </div>
